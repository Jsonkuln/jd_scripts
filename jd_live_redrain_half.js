...
[task_local]
#半点京豆雨
30 20-23/1 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_live_redrain_half.js, tag=半点京豆雨, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
==============Loon==============
[Script]
cron "30 20-23/1 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_live_redrain_half.js,tag=半点京豆雨
================Surge===============
半点京豆雨 = type=cron,cronexp="30 20-23/1 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_live_redrain_half.js
===============小火箭==========
半点京豆雨 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_live_redrain_half.js, cronexpr="30 20-23/1 * * *", timeout=3600, enable=true
*/
const $ = new Env('半点京豆雨');
let allMessage = '', id = '';
...
let jd_redrain_half_url =  'https://gitee.com/msewb/update/raw/master/redrain_half.json';
if ($.isNode()) {
...
!(async () => {
  ...
  for (let id of redIds) {
    ...
    console.log(`\n甘露殿提醒你:龙王就位:${id}，正在领取${hour}点30分京豆雨\n`);
