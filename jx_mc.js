...
[task_local]
#京喜牧场
20 0-23/2 * * * jx_mc.js, tag=京喜牧场, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true
================Loon==============
[Script]
cron "20 0-23/2 * * *" script-path=jx_mc.js,tag=京喜牧场
===============Surge=================
京喜牧场 = type=cron,cronexp="20 0-23/2 * * *",wake-system=1,timeout=3600,script-path=jx_mc.js
============小火箭=========
京喜牧场 = type=cron,script-path=jx_mc.js, cronexpr="20 0-23/2 * * *", timeout=3600, enable=true
 */
