...
[task_local]
#金榜年终奖
10 0,12 * * * jd_split.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "10 0,12 * * *" script-path=jd_split.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="10 0,12 * * *",wake-system=1,timeout=3600,script-path=jd_split.js

============小火箭=========
金榜年终奖 = type=cron,script-path=jd_split.js, cronexpr="10 0,12 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终奖');
