...
[task_local]
#金榜年终奖
20 0,20 * * * jd_split.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "20 0,20 * * *" script-path=jd_split.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="20 0,20 * * *",wake-system=1,timeout=3600,script-path=jd_split.js

============小火箭=========
金榜年终奖 = type=cron,script-path=jd_split.js, cronexpr="20 0,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终奖');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/yongyuanlin/cast/main/mast/split.json')
  if (!res) {
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/yongyuanlin/cast@main/mast/split.json')
  }
