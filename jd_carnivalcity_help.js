...
[task_local]
#京东手机狂欢城助力
10 1,21 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_carnivalcity_help.js, tag=京东手机狂欢城助力, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "10 1,21 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_carnivalcity_help.js, tag=京东手机狂欢城助力

====================Surge================
京东手机狂欢城助力 = type=cron,cronexp=10 1,21 * * *,wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_carnivalcity_help.js

============小火箭=========
京东手机狂欢城助力 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_carnivalcity_help.js, cronexpr="10 1,21 * * *", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  $.temp = [];
  $.updatePkActivityIdRes = await getAuthorShareCode('https://raw.githubusercontent.com/yongyuanlin/cast/main/mast/jd_cityShareCodes.json')
  if (!$.updatePkActivityIdRes) {
    $.updatePkActivityIdRes = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/yongyuanlin/cast@main/mast//jd_cityShareCodes.json')
  }
  await requireConfig();
