...
[task_local]
#京东评价
37 20 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_evaluation.js, tag=京东评价, enabled=true

================Loon==============
[Script]
cron "37 20 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_evaluation.js,tag=京东评价

===============Surge=================
京东评价 = type=cron,cronexp="37 20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_evaluation.js

============小火箭=========
京东评价 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_evaluation.js, cronexpr="37 20 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东评价');
