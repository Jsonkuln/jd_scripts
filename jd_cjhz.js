...
[task_local]
#京东超级盒子
24 8,21 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_cjhz.js, tag=京东超级盒子, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "24 8,21 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_cjhz.js,tag=京东超级盒子

===============Surge=================
京东超级盒子 = type=cron,cronexp="24 8,21 * * **",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_cjhz.js

============小火箭=========
京东超级盒子 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_cjhz.js, cronexpr="24 8,21 * * *", timeout=3600, enable=true
 */
...
!(async () => {
    ...
    $.shareCoseList = [...new Set([...$.shareCoseList,'-ZBqBhBUJpXoF6SGGEWUNA','vCTjdEnbamWaf9aG3I2TCw'])]
    //去助力与开箱
    for (let i = 0; i < cookiesArr.length; i++) {
        cookie = cookiesArr[i];
        if (cookie) {
