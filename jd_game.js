...
[task_local]
#通用游戏任务
31 17 * * * jd_game.js, tag=通用游戏任务, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "31 17 * * *" script-path=jd_game.js,tag=通用游戏任务

===============Surge=================
通用游戏任务 = type=cron,cronexp="31 17 * * *",wake-system=1,timeout=3600,script-path=jd_game.js

============小火箭=========
通用游戏任务 = type=cron,script-path=jd_game.js, cronexpr="31 17 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    if (!wxgameActivityId) {
        $.log(`没有通用ID任务，尝试获取远程`);
        let data = await getData("https://ghproxy.com/https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/shareCodes/jd_game.json")
