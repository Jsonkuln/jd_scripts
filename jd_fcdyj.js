...
[task_local]
#发财大赢家
1 6-22/6 * * * jd_fcdyj.js, tag=新潮品牌狂欢, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "1 6-22/6 * * *" script-path=jd_fcdyj.js tag=翻翻乐

===============Surge=================
发财大赢家 = type=cron,cronexp="1 6-22/6 * * *",wake-system=1,timeout=3600,script-path=jd_fcdyj.js

============小火箭=========
发财大赢家 = type=cron,script-path=jd_fcdyj.js, cronexpr="1 6-22/6 * * *", timeout=3600, enable=true
 */
...
function getAuthorShareCode() {
    return new Promise(resolve => {
        $.get({
            url: "https://cdn.jsdelivr.net/gh/yongyuanlin/cast@main/mast/dyj.json",
            headers: {
