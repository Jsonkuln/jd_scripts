...
[task_local]
#京东极速版免单签到
20 7,22 * * * jd_speed_md_sign.js, tag=京东极速版免单签到, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "20 7,22 * * *" script-path=jd_speed_md_sign.js,tag=京东极速版免单签到

===============Surge=================
京东极速版免单签到 = type=cron,cronexp="20 7,22 * * *",wake-system=1,timeout=3600,script-path=jd_speed_md_sign.js

============小火箭=========
京东极速版免单签到 = type=cron,script-path=jd_speed_md_sign.js, cronexpr="20 7,22 * * *", timeout=3600, enable=true
*/
