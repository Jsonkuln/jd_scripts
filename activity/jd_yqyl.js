...
[task_local]
#邀请有礼
5 14 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_yqyl.js, tag=邀请有礼, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "5 14 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_yqyl.js,tag=邀请有礼
=================================Surge================================
邀请有礼 = type=cron,cronexp="5 14 * * *",wake-system=1,timeout=3600,script-path=hhttps://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_yqyl.js
====================================小火箭=============================
邀请有礼 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_yqyl.js, cronexpr="5 14 * * *", timeout=3600, enable=true
 */
const $ = new Env('邀请有礼');
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            if(helpAuthorFlag){
                try{
                    helpAuthorInfo = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/yongyuanlin/cast/main/mast/yqyl.json');
                }catch (e) {}
                if(!helpAuthorInfo){
                    helpAuthorInfo = [];
                }
