...
[task_local]
#星店长
5 7,14,20 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_star.js, tag=星店长, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_star.png, enabled=true
===================Loon==============
[Script]
cron "5 7,14,20 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_star.js, tag=星店长
===============Surge===============
[Script]
星店长 = type=cron,cronexp="5 7,14,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/ZFeng1005/MyScripts/jd_scripts/jd_star.js
====================================小火箭=============================
星店长 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_star.js, cronexpr="5 7,14,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('星店长');
