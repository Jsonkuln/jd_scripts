...
!(async () => {
  ...
  if (cookiesArr.length > 2) {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
      ...
      console.log(`${$.UserName}账号内部互助已完成，尝试帮【作者】助力`)
...
function getAuthorShareCode() {
  return new Promise(resolve => {
    $.get({
      url: "https://cdn.jsdelivr.net/gh/yongyuanlin/cast@main/mast/qjd.json",
      headers: {
