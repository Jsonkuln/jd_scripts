...
[task_local]
#东东玩家
20 0,21 * * * jd_ddwj_help.js, tag= 东东玩家
================Loon==============
[Script]
cron "20 0,21 * * *" sjd_ddwj_help.js,tag= 东东玩家
===============Surge=================
东东玩家 = type=cron,cronexp="20 0,21 * * *",wake-system=1,timeout=3600,script-path= jd_ddwj_help.js
============小火箭=========
东东玩家 = type=cron,script-path= jd_ddwj_help.js, cronexpr="20 0,21 * * *", timeout=3600, enable=true
 */
