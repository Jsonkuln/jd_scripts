...
[task_local]
#预售福利机
8 0,8 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_ys.js, tag=预售福利机, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "8 0,8 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_ys.js,tag=预售福利机

===============Surge=================
预售福利机 = type=cron,cronexp="8 0,8 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_ys.js

============小火箭=========
预售福利机 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_ys.js, cronexpr="8 0,8 * * *", timeout=3600, enable=true
 */
const $ = new Env('预售福利机');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/yongyuanlin/cast/main/mast/ys.json')
  if (!res) {
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/yongyuanlin/cast@main/mast/ys.json')
  }
