...
[task_local]
#京东保价
10 0,12,22 * * * jd_priceProtect.js, tag=京东保价, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "10 0,12,22 * * *" script-path=jd_priceProtect.js,tag=京东保价

===============Surge=================
京东保价 = type=cron,cronexp="10 0,12,22 * * *",wake-system=1,timeout=3600,script-path=jd_priceProtect.js

============小火箭=========
京东保价 = type=cron,script-path=jd_priceProtect.js, cronexpr="10 0,12,22 * * *", timeout=3600, enable=true
 */
